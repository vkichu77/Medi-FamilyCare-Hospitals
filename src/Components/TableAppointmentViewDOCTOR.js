...
function TableAppointmentViewDOCTOR({mystylebor}) {
  ...
  function getallappointments() {
    fetch('/getallappointmentsDOCTOR')
    .then(response => {
      if(response.status === 401) {          
        throw new Error("Error: Table AppointmentsDetailsDOCTOR");
...
export default TableAppointmentViewDOCTOR;
