...
import TableAppointmentInsert from "./TableAppointmentInsert";
import TableAppointmentModify from "./TableAppointmentModify";
import TableAppointmentView from "./TableAppointmentView";

import TableAppointmentViewDOCTOR from "./TableAppointmentViewDOCTOR";


function TableAppointmentOperations() { 
    
    const [styleaccess1, Setstyleaccess1] = useState("");
    const [styleaccess2, Setstyleaccess2] = useState("border border-3 border-primary"); 
    const funcUpdateAPPOINTMENT = React.useRef(null);    
    const funcViewAPPOINTMENT = React.useRef(null);
    ...
    return (    
        <div>
          ...
          { (sessdata["TYPE"] !== "DOCTOR") &&
              ...
              className="mb-3"
              >
                  <Tab eventKey="home" title="Table: Appointment Details" disabled>
                  </Tab>              
                  <Tab eventKey="insert" title="Insert">            
                  <TableAppointmentInsert mystylebor={styleaccess2} funcUpdateAPPOINTMENT={funcUpdateAPPOINTMENT} funcViewAPPOINTMENT={funcViewAPPOINTMENT}/>            
                  </Tab>
                  <Tab eventKey="modify" title="Modify">
                  <TableAppointmentModify mystylebor={styleaccess2} funcUpdateAPPOINTMENT={funcUpdateAPPOINTMENT} funcViewAPPOINTMENT={funcViewAPPOINTMENT}/>            
                  </Tab>
                  <Tab eventKey="view" title="View">
                  <TableAppointmentView mystylebor={styleaccess2} funcViewAPPOINTMENT={funcViewAPPOINTMENT}/>
                  </Tab>
              </Tabs>
          }
          { (sessdata["TYPE"] === "DOCTOR") &&
              <Tabs
                  ...
                  <Tab eventKey="view" title="View">
                  <TableAppointmentViewDOCTOR mystylebor={styleaccess2} />
                  </Tab>
              </Tabs>
          }
          </div>         
...
export default TableAppointmentOperations;