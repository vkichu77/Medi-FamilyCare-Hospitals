...
function TableAppointmentView({ mystylebor, funcViewAPPOINTMENT }) {
  ...
  useEffect(() => { 
    funcViewAPPOINTMENT.current = getallappointments;
          ...
          <Card className="shadow">
            <Card.Body>
              <div className="mb-3 mt-4">
                <h2 className="fw-bold mb-2 text-uppercase">View Records: Appointment Details</h2>
                <div className=" mt-5">
...
export default TableAppointmentView;
